...
python_path = "/home/jonathan/git/HolisticFramework/.droNS3_venv/bin/python"
...
def run_baseline(input_file, fixed_alpha=1.0, fixed_v=INITIAL_V):
	...
	with open(fw_out_path+"baseline_stats.txt", "a") as f:
		f.write(f"{{sensors:{total_sensors_collected}, alpha:{fixed_alpha}, time:{cumulative_time}, average_lat:{cumulative_latency/total_sensors_collected}, sorties:{iteration}, noise:{noise}, good_tour:{good_tour}, replanned:{replanned}, input:{input_file}}}\n")
